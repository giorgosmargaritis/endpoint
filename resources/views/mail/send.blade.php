            ...
            <div class="u-row"
              ...
              <div
                ...
                <div class="u-col u-col-100"
                  ...
                  <div
                    style="background-color: #bdd1f9;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-font-size"
                                style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 40px; font-weight: 700;">
                                <span><span><strong>Connector</strong></span></span></h1>
                    ...
                    <div
                      ...
                      <table id="u_content_text_deprecated_7" style="font-family:'Open Sans',sans-serif;"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:50px 50px 40px;font-family:'Open Sans',sans-serif;"
                              align="left">
                              ...
                              <div class="v-font-size"
                                ...
                                <p style="line-height: 140%; font-size: 14px;"><span
                                    style="font-family: 'Open Sans', sans-serif; font-size: 16px; line-height: 22.4px;"><strong>#Date</strong></span>
                                </p>
                                <p style="line-height: 140%; font-size: 14px;"> </p>
                                <p style="line-height: 140%; font-size: 14px;"><span
                                    style="font-family: 'Open Sans', sans-serif; font-size: 16px; line-height: 22.4px;"><strong>Page Access Token Expiration</strong></span></p>
                                <p style="line-height: 140%; font-size: 14px;"> </p>
                                <p style="line-height: 140%; font-size: 14px;">Dear admin, your facebook access token is about to end. Generate a new one and update your facebook endpoint.</p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
